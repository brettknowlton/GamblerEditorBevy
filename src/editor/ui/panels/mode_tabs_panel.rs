...
use crate::{
    editor_modes::{tile_mode::TileID, EditorObjectKind},
    EditorState,
};
                ...
                .show(ui, |ui| {
                    ui.vertical(|ui| {
                        ...
                        if tab(ui, "1: Tile", tile_active).clicked() {
                            next_state
                                .set(EditorState::Editing(EditorObjectKind::Tile(TileID::Any)));
                        }
