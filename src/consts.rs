...
pub const PLAYER_WALK_SPEED: u32 = 10;
pub const MAX_PLAYER_WALK_SPEED: u32 = 100;

pub const PLAYER_JUMP_FORCE: u32 = 10000;
pub const PLAYER_JUMP_GRACE_PERIOD: f32 = 15.;
